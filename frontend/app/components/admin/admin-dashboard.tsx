                    ...
                    <CardContent className="p-0">
                      <div className="grid gap-4 p-4 lg:grid-cols-[1fr_auto_1fr] lg:items-stretch">
                          ...
                          <dl className="mt-auto space-y-2">
                            ...
                            <MatchAttributeRow label="Slots">
                              <span className="break-words text-xs text-muted-foreground">
                                {tutorSlots.length ? `${tutorSlots.length} · ${slotSummary(tutorSlots)}` : "—"}
                              </span>
                            </MatchAttributeRow>
                        ...
                        <div className="flex flex-col rounded-lg border bg-card p-4 shadow-sm">
                          ...
                          <dl className="mt-auto space-y-2">
                            ...
                            <MatchAttributeRow label="Slots">
                              <span className="break-words text-xs text-muted-foreground">
                                {tuteeSlots.length ? `${tuteeSlots.length} · ${slotSummary(tuteeSlots)}` : "—"}
                              </span>
                            </MatchAttributeRow>
                          </dl>
                        </div>
                      ...
                      <div className="space-y-2 border-t bg-muted/30 px-4 py-3">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {a.manual_override ? (
                            <Badge variant="destructive" className="text-xs">Manual override</Badge>
                          ) : null}
                        </div>
