...
/** Tutor document shape returned on assignment rows (Mongo + CP-SAT normalization). */
...
/** Tutee document shape returned on assignment rows (Mongo + CP-SAT normalization). */
